package uk.gov.justice.digital.hmpps.hmppselectronicmonitoringdataplatformapi.integration.config
...
object PostgresContainer {
  ...
  private fun startPostgresqlContainer(): PostgreSQLContainer<Nothing>? {
    ...
    return PostgreSQLContainer<Nothing>("postgres").apply {
      ...
      withDatabaseName("DeviceWearers")
      withUsername("DeviceWearers")
      withPassword("DeviceWearers")
